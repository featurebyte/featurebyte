...
public class TimestampToIndexTest {
  ...
  public void testConvertTimestampToIndex() throws HiveException {
    ...
    DeferredObject timeModuloFrequencySeconds = new GenericUDF.DeferredJavaObject(new IntWritable(0));
    ...
    DeferredObject[] args = {eventTimestamp, timeModuloFrequencySeconds, blindSpotSeconds, frequencyMinute};
