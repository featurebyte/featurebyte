create or replace procedure SP_TILE_GENERATE_SCHEDULE(FEATURE_NAME varchar, WINDOW_END_MINUTE float, BLINDSPOT_RESIDUE_SECONDS float, FREQUENCY_MINUTE float, SQL varchar, COLUMN_NAMES varchar, TYPE varchar, MONITOR_PERIODS float)
returns string
language javascript
as
$$
    ...
    var end_ts = new Date()
    //var end_ts = new Date(Date.parse('2022-05-26 00:28:00 UTC'))
