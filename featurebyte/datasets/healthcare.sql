...
CREATE TABLE HEALTHCARE.__ICD9HIERARCHY USING DELTA AS SELECT * FROM temp_table;
...
CREATE TABLE HEALTHCARE.__MEDICALPRODUCT USING DELTA AS SELECT * FROM temp_table;
...
CREATE TABLE HEALTHCARE.__SPECIALTYGROUP USING DELTA AS SELECT * FROM temp_table;
