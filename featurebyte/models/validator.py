...
def construct_data_model_root_validator(
    ...
    expected_column_name_type_pairs: List[Tuple[str, Optional[Set[DBVarType]]]],
) -> Any:
    """
    ...
    ----------
    columns_info_key: str
        Key used to retrieve columns_info from the models input
    expected_column_name_type_pairs: List[Tuple[str, Optional[Set[DBVarType]]]]
    ...
    def _root_validator(cls, values: dict[str, Any]) -> dict[str, Any]:
        ...
        for col_name, expected_db_types in expected_column_name_type_pairs:
