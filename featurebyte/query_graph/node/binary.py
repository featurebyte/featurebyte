...
class OrNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.OR.value] = NodeType.OR.value
...
class EqualNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.EQ.value] = NodeType.EQ.value
...
class NotEqualNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.NE.value] = NodeType.NE.value
...
class GreaterThanNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.GT.value] = NodeType.GT.value
...
class GreaterEqualNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.GE.value] = NodeType.GE.value
...
class LessThanNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.LT.value] = NodeType.LT.value
...
class LessEqualNode(BinaryOpWithBoolOutputNode):
    ...
    type: Literal[NodeType.LE.value] = NodeType.LE.value
...
class AddNode(BinaryArithmeticOpNode):
    ...
    type: Literal[NodeType.ADD.value] = NodeType.ADD.value
...
class SubtractNode(BinaryArithmeticOpNode):
    ...
    type: Literal[NodeType.SUB.value] = NodeType.SUB.value
...
class MultiplyNode(BinaryArithmeticOpNode):
    ...
    type: Literal[NodeType.MUL.value] = NodeType.MUL.value
