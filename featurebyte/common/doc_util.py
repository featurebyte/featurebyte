...
class FBAutoDoc(BaseModel):
    ...
    # Setting this to True will skip the rendering of the signature in the documentation for the class.
    # This will typically be used for classes which should not be initialized directly through its constructor,
    # and should normally be created via a factory method. For example, the Feature class should not be initialized
    # directly. The documentation for the Feature class should not show the constructor signature, and should have
    # links in the See Also section to point users to the factory methods.
    hide_signature_in_class_docs: bool = Field(default=False)
