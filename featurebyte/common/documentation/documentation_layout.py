...
def _get_feature_layout() -> List[DocLayoutItem]:
    ...
    return [
        *_get_feature_or_target_items(FEATURE),
        ...
        DocLayoutItem([FEATURE, TRANSFORM, "Feature.cd.normalize"]),
...
def _get_feature_list_layout() -> List[DocLayoutItem]:
    ...
    return [
        ...
        DocLayoutItem([FEATURE_LIST, LINEAGE, "FeatureList.naive_prediction"]),
...
def _get_utility_classes_layout() -> List[DocLayoutItem]:
    ...
    return [
        ...
        DocLayoutItem([UTILITY_CLASSES, ENUMS, "FeatureType"]),
        DocLayoutItem([UTILITY_CLASSES, ENUMS, "NaivePredictionStructure"]),
        ...
        DocLayoutItem([UTILITY_CLASSES, CONTEXT, "UserProvidedColumn"]),
...
def _get_deployment_layout() -> List[DocLayoutItem]:
    ...
    return [
        ...
        DocLayoutItem([DEPLOYMENT, SERVE, "Deployment.compute_batch_features"]),
...
def _get_target_layout() -> List[DocLayoutItem]:
    ...
    return [
        *_get_feature_or_target_items(TARGET),
        ...
        DocLayoutItem([TARGET, MANAGE, "TargetNamespace.update_positive_label"]),
        DocLayoutItem([TARGET, MANAGE, "Target.update_target_type"]),
        DocLayoutItem([TARGET, MANAGE, "Target.update_positive_label"]),
    ]
...
def _get_context_layout() -> List[DocLayoutItem]:
    ...
    return [
        ...
        DocLayoutItem([CONTEXT, INFO, "Context.get_forecast_point_feature"]),
