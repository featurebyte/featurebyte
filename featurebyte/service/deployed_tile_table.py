...
from featurebyte.models.deployed_tile_table import DeployedTileTableModel, DeployedTileTableUpdate
from featurebyte.service.base_document import BaseDocumentService


class DeployedTileTableService(
    BaseDocumentService[DeployedTileTableModel, DeployedTileTableModel, DeployedTileTableUpdate]
):
    """
    DeployedTileTableService class
    """
    ...
    document_update_class = DeployedTileTableUpdate
