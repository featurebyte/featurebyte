...
class WindowAggregator(BaseAggregator):
    ...
    def _prepare_node_parameters(
        ...
        return {
            ...
            "blind_spot": parsed_feature_job_setting.blind_spot_secs,
            "time_modulo_frequency": parsed_feature_job_setting.time_modulo_frequency_secs,
            "frequency": parsed_feature_job_setting.frequency_secs,
            "names": feature_names,
