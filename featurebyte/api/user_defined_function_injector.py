...
class UserDefinedFunctionInjector:
    ...
    def _generate_docstring(udf: UserDefinedFunctionModel) -> str:
        ...
        This function uses the feature store SQL function `{udf.function_name}` to generate a new column
        ...
        Union[ViewColumn, Feature]
            A new column or new feature generated by the feature store function `{udf.function_name}`.
        """
