...
def test_schedule_monitor_tile_online(snowflake_session):
    ...
    sql = f"call SP_TILE_GENERATE_SCHEDULE('{tile_id}', 183, 3, 5, 1440, '{tile_sql}', '{InternalName.TILE_START_DATE}', '{InternalName.TILE_START_DATE_SQL_PLACEHOLDER}', '{InternalName.TILE_END_DATE_SQL_PLACEHOLDER}', '{col_names}', 'ONLINE', {tile_monitor}, '{tile_end_ts_2}')"
    snowflake_session.execute_query(sql)
