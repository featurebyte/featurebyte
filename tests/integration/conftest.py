...
def scd_dataframe_fixture():
    """
    DataFrame fixture with slowly changing dimension
    """
    yield pd.read_csv("tests/fixtures/dataframe/scd_data.csv", parse_dates=["Effective Timestamp"])
...
def observation_set():
    ...
    """
    yield pd.read_csv("tests/fixtures/dataframe/observation_set.csv", parse_dates=["POINT_IN_TIME"])
