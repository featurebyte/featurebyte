WITH ONLINE_MY_REQUEST_TABLE AS (
  ...
  SELECT
    ...
    "T1"."_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774" AS "_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774"
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      FROM (
        ...
        WHERE
          "AGGREGATION_RESULT_NAME" IN ('_fb_internal_window_w7200_avg_f37862722c21105449ad882409cf62a1ff7f5b35')
      )   PIVOT(  MAX("VALUE") FOR "AGGREGATION_RESULT_NAME" IN ('_fb_internal_window_w7200_avg_f37862722c21105449ad882409cf62a1ff7f5b35'))
    )
  ) AS T0
  ...
  LEFT JOIN (
    ...
    FROM (
      SELECT
        "BUSINESS_ID",
        "'_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774'" AS "_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774"
      FROM (
        SELECT
          "BUSINESS_ID",
          "AGGREGATION_RESULT_NAME",
        ...
        FROM (
          ...
          FROM (
            SELECT
              ...
              "LATEST_VERSION"
            FROM (VALUES
              ('_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774', _fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774_VERSION_PLACEHOLDER)) AS version_table("AGGREGATION_RESULT_NAME", "LATEST_VERSION")
          ) AS L
        ...
        WHERE
          "AGGREGATION_RESULT_NAME" IN ('_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774')
      )   PIVOT(  MAX("VALUE") FOR "AGGREGATION_RESULT_NAME" IN ('_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774'))
    )
  ) AS T1
...
SELECT
  AGG."CUSTOMER_ID",
  (
    "_fb_internal_window_w7200_avg_f37862722c21105449ad882409cf62a1ff7f5b35" / NULLIF("_fb_internal_window_w604800_sum_d5ebb5711120ac12cb84f6136654c6dba7e21774", 0)
