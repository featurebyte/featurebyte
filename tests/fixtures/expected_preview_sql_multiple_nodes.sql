...
sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285 AS (
    SELECT *, F_TIMESTAMP_TO_INDEX(  __FB_TILE_START_DATE_COLUMN,  1800,  900,  60) AS "INDEX" FROM (
        SELECT
...
_FB_AGGREGATED AS (SELECT
  ...
  "T2"."agg_w7200_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285" AS "agg_w7200_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285",
  "T3"."agg_w129600_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285" AS "agg_w129600_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285"
...
LEFT JOIN (
    SELECT
      REQ.POINT_IN_TIME,
      REQ."CUSTOMER_ID",
      SUM(value) AS "agg_w7200_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285"
    FROM REQUEST_TABLE_W7200_F3600_BS900_M1800_CUSTOMER_ID AS REQ
    INNER JOIN sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285 AS TILE
      ON REQ.REQ_TILE_INDEX = TILE.INDEX
      AND REQ."CUSTOMER_ID" = TILE."cust_id"
    GROUP BY
      REQ.POINT_IN_TIME,
...
LEFT JOIN (
    SELECT
      REQ.POINT_IN_TIME,
      REQ."CUSTOMER_ID",
      SUM(value) AS "agg_w129600_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285"
...
SELECT
  ...
  "agg_w7200_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285" AS "a_2h_sum",
  "agg_w129600_sum_f3600_m1800_b900_33e0be3e51a8dcf07366d50e0d130f6c30798285" AS "a_36h_sum"
