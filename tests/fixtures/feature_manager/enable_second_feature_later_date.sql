...
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      WHERE
        "event_timestamp" >= CAST('2022-05-15T05:45:00.000000Z' AS TIMESTAMP)
        AND "event_timestamp" < CAST('2022-05-15T06:45:00.000000Z' AS TIMESTAMP)
    )
    WHERE
      "event_timestamp" >= CAST('2022-05-15T05:45:00.000000Z' AS TIMESTAMP)
      AND "event_timestamp" < CAST('2022-05-15T06:45:00.000000Z' AS TIMESTAMP)
...
FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      FROM "sf_database"."sf_schema"."sf_table"
      WHERE
        "event_timestamp" >= CAST('2022-05-15T08:45:00.000000Z' AS TIMESTAMP)
        AND "event_timestamp" < CAST('2022-05-15T09:45:00.000000Z' AS TIMESTAMP)
    )
    WHERE
      "event_timestamp" >= CAST('2022-05-15T08:45:00.000000Z' AS TIMESTAMP)
      AND "event_timestamp" < CAST('2022-05-15T09:45:00.000000Z' AS TIMESTAMP)
