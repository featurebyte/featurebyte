WITH "REQUEST_TABLE_W1800_F1800_BS600_M300_NEW_CUST_ID" AS (
  ...
  SELECT
    ...
    REQ."B",
    REQ."C",
    "T0"."agg_w1800_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85" AS "agg_w1800_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85",
    "T1"."agg_w7200_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85" AS "agg_w7200_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85",
    "T2"."agg_w86400_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85" AS "agg_w86400_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85"
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."NEW_CUST_ID",
      SUM(value_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85) AS "agg_w1800_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85"
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."NEW_CUST_ID",
      SUM(value_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85) AS "agg_w7200_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85"
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."NEW_CUST_ID",
      SUM(value_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85) AS "agg_w86400_sum_072a1700018ba111c99ff5d80e934ef4dd5a9f85"
