WITH "REQUEST_TABLE_W1800_F1800_BS600_M300_NEW_CUST_ID" AS (
    SELECT
      POINT_IN_TIME,
      "NEW_CUST_ID",
      FLOOR((DATE_PART(EPOCH_SECOND, POINT_IN_TIME) - 300) / 1800) AS "__FB_LAST_TILE_INDEX",
      FLOOR((DATE_PART(EPOCH_SECOND, POINT_IN_TIME) - 300) / 1800) - 1 AS "__FB_FIRST_TILE_INDEX"
    FROM (
        SELECT DISTINCT
          POINT_IN_TIME,
          "NEW_CUST_ID"
    ...
    SELECT
      ...
      "NEW_CUST_ID",
      FLOOR((DATE_PART(EPOCH_SECOND, POINT_IN_TIME) - 300) / 1800) AS "__FB_LAST_TILE_INDEX",
      FLOOR((DATE_PART(EPOCH_SECOND, POINT_IN_TIME) - 300) / 1800) - 4 AS "__FB_FIRST_TILE_INDEX"
    FROM (
        SELECT DISTINCT
          POINT_IN_TIME,
          "NEW_CUST_ID"
    ...
    SELECT
      ...
      "NEW_CUST_ID",
      FLOOR((DATE_PART(EPOCH_SECOND, POINT_IN_TIME) - 300) / 1800) AS "__FB_LAST_TILE_INDEX",
      FLOOR((DATE_PART(EPOCH_SECOND, POINT_IN_TIME) - 300) / 1800) - 48 AS "__FB_FIRST_TILE_INDEX"
    FROM (
        SELECT DISTINCT
          POINT_IN_TIME,
          "NEW_CUST_ID"
