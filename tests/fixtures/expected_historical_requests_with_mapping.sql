WITH "REQUEST_TABLE_W1800_F1800_BS600_M300_NEW_CUST_ID" AS (
  ...
  SELECT
    ...
    REQ."B",
    REQ."C",
    "T0"."agg_w1800_sum_a1a9657e29a711c4d09475bb8285da86250d2294" AS "agg_w1800_sum_a1a9657e29a711c4d09475bb8285da86250d2294",
    "T1"."agg_w7200_sum_a1a9657e29a711c4d09475bb8285da86250d2294" AS "agg_w7200_sum_a1a9657e29a711c4d09475bb8285da86250d2294",
    "T2"."agg_w86400_sum_a1a9657e29a711c4d09475bb8285da86250d2294" AS "agg_w86400_sum_a1a9657e29a711c4d09475bb8285da86250d2294"
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."NEW_CUST_ID",
      SUM(value_sum_a1a9657e29a711c4d09475bb8285da86250d2294) AS "agg_w1800_sum_a1a9657e29a711c4d09475bb8285da86250d2294"
    FROM "REQUEST_TABLE_W1800_F1800_BS600_M300_NEW_CUST_ID" AS REQ
    INNER JOIN TILE_F1800_M300_B600_7BEF0E8B579190F960845A042B02B9BC538BD58E AS TILE
      ON (
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."NEW_CUST_ID",
      SUM(value_sum_a1a9657e29a711c4d09475bb8285da86250d2294) AS "agg_w7200_sum_a1a9657e29a711c4d09475bb8285da86250d2294"
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."NEW_CUST_ID",
      SUM(value_sum_a1a9657e29a711c4d09475bb8285da86250d2294) AS "agg_w86400_sum_a1a9657e29a711c4d09475bb8285da86250d2294"
