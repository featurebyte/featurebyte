...
CREATE TABLE "__TEMP_61cf998089c9f811f33c895b_0" AS
...
FROM "__TEMP_61cf998089c9f811f33c895b_0";

CREATE TABLE "__TEMP_61cf998089c9f811f33c895b_1" AS
WITH ONLINE_REQUEST_TABLE AS (
  SELECT
    REQ."__FB_TABLE_ROW_INDEX",
    REQ."cust_id",
...
SELECT
  COUNT(DISTINCT "__FB_TABLE_ROW_INDEX") = COUNT(*) AS "is_row_index_valid"
FROM "__TEMP_61cf998089c9f811f33c895b_1";
...
SELECT
  ...
  T1."composite_entity_feature_1d_plus_123_V220101",
...
LEFT JOIN "__TEMP_61cf998089c9f811f33c895b_0" AS T0
  ON REQ."__FB_TABLE_ROW_INDEX" = T0."__FB_TABLE_ROW_INDEX"
LEFT JOIN "__TEMP_61cf998089c9f811f33c895b_1" AS T1
