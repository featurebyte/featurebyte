WITH REQUEST_TABLE AS (
...
), JOINED_JOB_SCHEDULES_REQUEST_TABLE AS (
  SELECT
    L."POINT_IN_TIME" AS "POINT_IN_TIME",
    L."CUSTOMER_ID" AS "CUSTOMER_ID",
    R."__FB_CRON_JOB_SCHEDULE_DATETIME" AS "__FB_CRON_JOB_SCHEDULE_DATETIME_0 0 * * *_Etc/UTC_Asia/Singapore"
  FROM (
    SELECT
      "__FB_LAST_TS",
      "POINT_IN_TIME",
  ...
  FROM "JOINED_JOB_SCHEDULES_REQUEST_TABLE"
  ...
  SELECT
    REQ."POINT_IN_TIME",
    REQ."CUSTOMER_ID",
    REQ."__FB_CRON_JOB_SCHEDULE_DATETIME_0 0 * * *_Etc/UTC_Asia/Singapore",
  ...
  FROM JOINED_JOB_SCHEDULES_REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
