WITH TILE_F3600_M1800_B900_8502F6BC497F17F84385ABE4346FD392F2F56725 AS (
  ...
  SELECT
    ...
    REQ."CUSTOMER_ID",
    REQ."COL_INT",
    "T0"."agg_w7200_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a" AS "agg_w7200_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a",
    "T1"."agg_w172800_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a" AS "agg_w172800_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a"
  FROM JOINED_PARENTS_REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."CUSTOMER_ID",
      SUM(sum_value_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a) / SUM(count_value_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a) AS "agg_w7200_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a"
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."CUSTOMER_ID",
      SUM(sum_value_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a) / SUM(count_value_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a) AS "agg_w172800_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a"
...
SELECT
  AGG."POINT_IN_TIME",
  AGG."CUSTOMER_ID",
  "agg_w7200_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a" AS "a_2h_average",
  "agg_w172800_avg_e0c1a10c943c5125b7c394567b1958216cdd0f7a" AS "a_48h_average"
