...
), "VIEW_2d1f272fedaefd29_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
    ...
    LEFT JOIN (
      ...
      FROM (
        ...
        FROM (
          ...
          INNER JOIN "VIEW_2d1f272fedaefd29_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
        ...
        INNER JOIN "VIEW_2d1f272fedaefd29" AS VIEW
