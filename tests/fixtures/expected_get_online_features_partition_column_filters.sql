...
WITH ONLINE_REQUEST_TABLE AS (
  ...
  FROM (
    ...
    WHERE
      "date" >= TO_CHAR(
        DATEADD(MONTH, -1, DATEADD(MONTH, -3, CAST('2023-10-01 12:00:00' AS TIMESTAMP))),
        'YYYY-MM-DD HH24:MI:SS'
      )
      AND "date" <= TO_CHAR(
        DATEADD(MONTH, 1, CAST('2023-10-01 12:00:00' AS TIMESTAMP)),
        'YYYY-MM-DD HH24:MI:SS'
      )
  )
), "VIEW_d9786a564d681dd4_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
    ...
    LEFT JOIN (
      ...
      FROM (
        ...
        FROM (
          ...
          INNER JOIN "VIEW_d9786a564d681dd4_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
        ...
        INNER JOIN "VIEW_d9786a564d681dd4" AS VIEW
