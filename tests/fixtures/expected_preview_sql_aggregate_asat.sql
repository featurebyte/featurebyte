WITH REQUEST_TABLE AS (
  ...
  SELECT
    REQ."POINT_IN_TIME",
    REQ."CUSTOMER_ID",
    "T0"."_fb_internal_MEMBERSHIP_STATUS_as_at_count_None_membership_status_None_input_1" AS "_fb_internal_MEMBERSHIP_STATUS_as_at_count_None_membership_status_None_input_1"
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME" AS "POINT_IN_TIME",
      REQ."MEMBERSHIP_STATUS" AS "MEMBERSHIP_STATUS",
      COUNT(*) AS "_fb_internal_MEMBERSHIP_STATUS_as_at_count_None_membership_status_None_input_1"
