WITH TILE_F3600_M1800_B900_8502F6BC497F17F84385ABE4346FD392F2F56725 AS (
  SELECT
    avg_e823fe7a3191330a0679e9a81157e812069df2ea.INDEX,
    avg_e823fe7a3191330a0679e9a81157e812069df2ea."cust_id",
    sum_value_avg_e823fe7a3191330a0679e9a81157e812069df2ea,
    count_value_avg_e823fe7a3191330a0679e9a81157e812069df2ea
  FROM (
    SELECT
      *,
    ...
    FROM (
      SELECT
        ...
        "cust_id",
        SUM("a") AS sum_value_avg_e823fe7a3191330a0679e9a81157e812069df2ea,
        COUNT("a") AS count_value_avg_e823fe7a3191330a0679e9a81157e812069df2ea
      FROM (
        SELECT
          *,
          FLOOR(
  ...
  ) AS avg_e823fe7a3191330a0679e9a81157e812069df2ea
), REQUEST_TABLE AS (
  SELECT
