WITH TILE_F3600_M1800_B900_8502F6BC497F17F84385ABE4346FD392F2F56725 AS (
  SELECT
    avg_1c188de62a7bc747411b27ce1eab193d61e98cb8.INDEX,
    avg_1c188de62a7bc747411b27ce1eab193d61e98cb8.`cust_id`,
    sum_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8,
    count_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8
  FROM (
    SELECT
      *,
    ...
    FROM (
      SELECT
        ...
        `cust_id`,
        SUM(`a`) AS sum_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8,
        COUNT(`a`) AS count_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8
      FROM (
        SELECT
          *,
          FLOOR(
  ...
  ) AS avg_1c188de62a7bc747411b27ce1eab193d61e98cb8
), REQUEST_TABLE AS (
  SELECT
  ...
  SELECT
    REQ.`POINT_IN_TIME`,
    REQ.`CUSTOMER_ID`,
    `T0`.`agg_w7200_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8` AS `agg_w7200_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8`,
    `T1`.`agg_w172800_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8` AS `agg_w172800_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8`
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ.`POINT_IN_TIME`,
      REQ.`CUSTOMER_ID`,
      SUM(sum_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8) / SUM(count_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8) AS `agg_w7200_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8`
  ...
  LEFT JOIN (
    SELECT
      REQ.`POINT_IN_TIME`,
      REQ.`CUSTOMER_ID`,
      SUM(sum_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8) / SUM(count_value_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8) AS `agg_w172800_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8`
...
SELECT
  AGG.`POINT_IN_TIME`,
  AGG.`CUSTOMER_ID`,
  `agg_w7200_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8` AS `a_2h_average`,
  `agg_w172800_avg_1c188de62a7bc747411b27ce1eab193d61e98cb8` AS `a_48h_average`
