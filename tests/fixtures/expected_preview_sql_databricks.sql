WITH TILE_F3600_M1800_B900_8502F6BC497F17F84385ABE4346FD392F2F56725 AS (
  SELECT
    avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32.INDEX,
    avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32.`cust_id`,
    sum_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32,
    count_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32
  FROM (
    SELECT
      *,
    ...
    FROM (
      SELECT
        ...
        `cust_id`,
        SUM(`a`) AS sum_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32,
        COUNT(`a`) AS count_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32
      FROM (
        SELECT
          *,
          FLOOR(
  ...
  ) AS avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32
), REQUEST_TABLE AS (
  SELECT
  ...
  SELECT
    REQ.`POINT_IN_TIME`,
    REQ.`CUSTOMER_ID`,
    `T0`.`agg_w7200_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32` AS `agg_w7200_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32`,
    `T1`.`agg_w172800_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32` AS `agg_w172800_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32`
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ.`POINT_IN_TIME`,
      REQ.`CUSTOMER_ID`,
      SUM(sum_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32) / SUM(count_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32) AS `agg_w7200_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32`
  ...
  LEFT JOIN (
    SELECT
      REQ.`POINT_IN_TIME`,
      REQ.`CUSTOMER_ID`,
      SUM(sum_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32) / SUM(count_value_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32) AS `agg_w172800_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32`
...
SELECT
  AGG.`POINT_IN_TIME`,
  AGG.`CUSTOMER_ID`,
  `agg_w7200_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32` AS `a_2h_average`,
  `agg_w172800_avg_ccc6c3d61999918a3a6c83fb3db6f69478118d32` AS `a_48h_average`
