...
SELECT
  AGG.`POINT_IN_TIME`,
  AGG.`CUSTOMER_ID`,
  `_fb_internal_CUSTOMER_ID_window_w7200_avg_f777ffee22ceceebb438d61cb44de17eb593fd38` AS `a_2h_average`,
  `_fb_internal_CUSTOMER_ID_window_w172800_avg_f777ffee22ceceebb438d61cb44de17eb593fd38` AS `a_48h_average`
