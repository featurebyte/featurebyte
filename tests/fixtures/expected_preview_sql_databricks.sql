WITH TILE_F3600_M1800_B900_8502F6BC497F17F84385ABE4346FD392F2F56725 AS (
  ...
  SELECT
    REQ.`POINT_IN_TIME`,
    REQ.`CUSTOMER_ID`,
    `T0`.`_fb_internal_window_w7200_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e` AS `_fb_internal_window_w7200_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e`,
    `T1`.`_fb_internal_window_w172800_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e` AS `_fb_internal_window_w172800_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e`
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ.`POINT_IN_TIME`,
      REQ.`CUSTOMER_ID`,
      SUM(sum_value_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e) / SUM(count_value_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e) AS `_fb_internal_window_w7200_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e`
  ...
  LEFT JOIN (
    SELECT
      REQ.`POINT_IN_TIME`,
      REQ.`CUSTOMER_ID`,
      SUM(sum_value_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e) / SUM(count_value_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e) AS `_fb_internal_window_w172800_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e`
...
SELECT
  AGG.`POINT_IN_TIME`,
  AGG.`CUSTOMER_ID`,
  `_fb_internal_window_w7200_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e` AS `a_2h_average`,
  `_fb_internal_window_w172800_avg_9046ae6c4b61cfb5aa14c78f72031f904b3e378e` AS `a_48h_average`
