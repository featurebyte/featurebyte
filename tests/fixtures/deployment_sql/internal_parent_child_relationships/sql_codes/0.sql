WITH DEPLOYMENT_REQUEST_TABLE AS (
  ...
  SELECT
    ...
    REQ."cust_id_696f157bfbed89cbc2912d45" AS "cust_id_696f157bfbed89cbc2912d45"
  FROM (
    SELECT
      L."cust_id" AS "cust_id",
      L."POINT_IN_TIME" AS "POINT_IN_TIME",
      R."col_boolean" AS "cust_id_696f157bfbed89cbc2912d45"
    FROM (
      SELECT
        "__FB_KEY_COL_0",
        "__FB_LAST_TS",
...
), "REQUEST_TABLE_POINT_IN_TIME_cust_id_696f157bfbed89cbc2912d45" AS (
  SELECT DISTINCT
    "POINT_IN_TIME",
    "cust_id_696f157bfbed89cbc2912d45"
  ...
  SELECT
    ...
    "T0"."_fb_internal_cust_id_696f157bfbed89cbc2912d45_as_at_count_None_col_boolean_None_project_1" AS "_fb_internal_cust_id_696f157bfbed89cbc2912d45_as_at_count_None_col_boolean_None_project_1"
  FROM (
    SELECT
      L."cust_id" AS "cust_id",
      L."POINT_IN_TIME" AS "POINT_IN_TIME",
      L."cust_id_696f157bfbed89cbc2912d45" AS "cust_id_696f157bfbed89cbc2912d45",
      ...
      FROM (
        ...
        FROM (
          SELECT
            ...
            "cust_id" AS "cust_id",
            "POINT_IN_TIME" AS "POINT_IN_TIME",
            "cust_id_696f157bfbed89cbc2912d45" AS "cust_id_696f157bfbed89cbc2912d45"
          FROM (
            SELECT
              REQ."cust_id",
              REQ."POINT_IN_TIME",
              REQ."cust_id_696f157bfbed89cbc2912d45"
          ...
          SELECT
            ...
            NULL AS "cust_id",
            NULL AS "POINT_IN_TIME",
            NULL AS "cust_id_696f157bfbed89cbc2912d45"
          FROM (
            SELECT
              "col_int" AS "col_int",
              "col_float" AS "col_float",
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME" AS "POINT_IN_TIME",
      REQ."cust_id_696f157bfbed89cbc2912d45" AS "cust_id_696f157bfbed89cbc2912d45",
      COUNT(*) AS "_fb_internal_cust_id_696f157bfbed89cbc2912d45_as_at_count_None_col_boolean_None_project_1"
    FROM "REQUEST_TABLE_POINT_IN_TIME_cust_id_696f157bfbed89cbc2912d45" AS REQ
    INNER JOIN (
      SELECT
        "col_int" AS "col_int",
        "col_float" AS "col_float",
      ...
      ON REQ."cust_id_696f157bfbed89cbc2912d45" = SCD."col_boolean"
      AND (
    ...
    AND REQ."cust_id_696f157bfbed89cbc2912d45" = T0."cust_id_696f157bfbed89cbc2912d45"
)
SELECT
  AGG."cust_id",
  (
    CONCAT(
      ...
      CAST("_fb_internal_cust_id_696f157bfbed89cbc2912d45_as_at_count_None_col_boolean_None_project_1" AS VARCHAR)
    )
