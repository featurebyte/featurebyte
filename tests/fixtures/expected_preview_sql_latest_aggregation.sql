WITH TILE_F3600_M1800_B900_5553F7746DB8FE154748D0FD9C06E1C1EDE7B165 AS (
  SELECT
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      INNER JOIN TILE_F3600_M1800_B900_5553F7746DB8FE154748D0FD9C06E1C1EDE7B165 AS TILE
        ON (
