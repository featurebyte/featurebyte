WITH TILE_F3600_M1800_B900_8502F6BC497F17F84385ABE4346FD392F2F56725 AS (
  ...
  SELECT
    REQ."POINT_IN_TIME",
    REQ."CUSTOMER_ID",
    "T0"."agg_w2592000_avg_b3d693b2f24a3b72386f1591e8cbdd4803cbf72e" AS "agg_w2592000_avg_b3d693b2f24a3b72386f1591e8cbdd4803cbf72e"
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."CUSTOMER_ID",
      SUM(sum_value_avg_b3d693b2f24a3b72386f1591e8cbdd4803cbf72e) / SUM(count_value_avg_b3d693b2f24a3b72386f1591e8cbdd4803cbf72e) AS "agg_w2592000_avg_b3d693b2f24a3b72386f1591e8cbdd4803cbf72e"
...
SELECT
  AGG."POINT_IN_TIME",
  AGG."CUSTOMER_ID",
  "agg_w2592000_avg_b3d693b2f24a3b72386f1591e8cbdd4803cbf72e" AS "order_size_30d_avg"
