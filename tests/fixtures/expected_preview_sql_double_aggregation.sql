WITH fake_transactions_table_f3600_m1800_b900_fa69ec6e12d9162469e8796a5d93c8a1e767dc0d AS (
  SELECT
    avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6.INDEX,
    avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6."cust_id",
    sum_value_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6,
    count_value_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6
  FROM (
    SELECT
      *,
    ...
    FROM (
      SELECT
        ...
        "cust_id",
        SUM("ord_size") AS sum_value_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6,
        COUNT("ord_size") AS count_value_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6
      FROM (
        SELECT
          *,
          FLOOR(
  ...
  SELECT
    REQ."POINT_IN_TIME",
    REQ."CUSTOMER_ID",
    "T0"."agg_w2592000_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6" AS "agg_w2592000_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6"
  FROM REQUEST_TABLE AS REQ
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."CUSTOMER_ID",
      SUM(sum_value_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6) / SUM(count_value_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6) AS "agg_w2592000_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6"
...
SELECT
  AGG."POINT_IN_TIME",
  AGG."CUSTOMER_ID",
  "agg_w2592000_avg_b57eb8b3fb058e40d54049d9579a426ca2364ed6" AS "order_size_30d_avg"
