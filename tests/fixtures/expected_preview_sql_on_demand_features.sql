WITH REQUEST_TABLE AS (
  ...
  SELECT
    latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d.INDEX,
    latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d."cust_id",
    value_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d
  FROM (
    WITH __FB_ENTITY_TABLE_NAME AS (
      ...
      INNER JOIN (
        SELECT
          "ts" AS "ts",
          "cust_id" AS "cust_id",
          "ts" AS "input_col_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d"
    ...
    FROM (
      SELECT
        ...
        FIRST_VALUE("input_col_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d") OVER (PARTITION BY index, "cust_id" ORDER BY "ts" DESC NULLS LAST) AS value_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d
      FROM (
        SELECT
          *,
    ...
    WHERE
      "__FB_ROW_NUMBER" = 1
  ) AS latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d
  ...
  SELECT
    REQ."POINT_IN_TIME",
    REQ."CUSTOMER_ID",
    "T0"."_fb_internal_CUSTOMER_ID_window_w7776000_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d" AS "_fb_internal_CUSTOMER_ID_window_w7776000_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d"
  ...
  LEFT JOIN (
    ...
    FROM (
      SELECT
        ...
        FIRST_VALUE(value_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d) OVER (PARTITION BY "POINT_IN_TIME", "CUSTOMER_ID" ORDER BY INDEX DESC NULLS LAST) AS "_fb_internal_CUSTOMER_ID_window_w7776000_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d"
      FROM (
        SELECT
          REQ."POINT_IN_TIME",
          REQ."CUSTOMER_ID",
          TILE.INDEX,
          TILE.value_latest_50f68db8e6d7bdc807e50be52095e09ea8901b8d
