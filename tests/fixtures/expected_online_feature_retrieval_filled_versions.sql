        ...
        FROM (
          ...
          FROM (
            SELECT
              ...
              "LATEST_VERSION"
            FROM (VALUES
              ('_fb_internal_CUSTOMER_ID_window_w172800_avg_f37862722c21105449ad882409cf62a1ff7f5b35', 0),
              ('_fb_internal_CUSTOMER_ID_window_w7200_avg_f37862722c21105449ad882409cf62a1ff7f5b35', 1)) AS version_table("AGGREGATION_RESULT_NAME", "LATEST_VERSION")
          ) AS L
