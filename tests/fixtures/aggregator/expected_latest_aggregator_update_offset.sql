SELECT
  ...
  REQ."b" AS "b",
  REQ."c" AS "c",
  REQ."_fb_internal_CUSTOMER_ID_BUSINESS_ID_latest_b4a6546e024f3a059bd67f454028e56c5a37826e_o172800" AS "_fb_internal_CUSTOMER_ID_BUSINESS_ID_latest_b4a6546e024f3a059bd67f454028e56c5a37826e_o172800"
FROM (
  SELECT
    L."a" AS "a",
    L."b" AS "b",
    L."c" AS "c",
    R.value_latest_b4a6546e024f3a059bd67f454028e56c5a37826e AS "_fb_internal_CUSTOMER_ID_BUSINESS_ID_latest_b4a6546e024f3a059bd67f454028e56c5a37826e_o172800"
  FROM (
    SELECT
      "__FB_KEY_COL_0",
      "__FB_KEY_COL_1",
