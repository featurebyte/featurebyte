SELECT
  ...
  REQ."b" AS "b",
  REQ."c" AS "c",
  REQ."_fb_internal_CUSTOMER_ID_BUSINESS_ID_latest_5d7c2d9af3442ddd52e26b3603f39aa922965d78_o172800" AS "_fb_internal_CUSTOMER_ID_BUSINESS_ID_latest_5d7c2d9af3442ddd52e26b3603f39aa922965d78_o172800"
FROM (
  SELECT
    L."a" AS "a",
    L."b" AS "b",
    L."c" AS "c",
    R.value_latest_5d7c2d9af3442ddd52e26b3603f39aa922965d78 AS "_fb_internal_CUSTOMER_ID_BUSINESS_ID_latest_5d7c2d9af3442ddd52e26b3603f39aa922965d78_o172800"
  FROM (
    SELECT
      "__FB_KEY_COL_0",
      "__FB_KEY_COL_1",
