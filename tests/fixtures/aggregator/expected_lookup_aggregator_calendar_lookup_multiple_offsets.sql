...
LEFT JOIN (
  ...
  ON TO_CHAR(DATE_TRUNC('day', REQ."POINT_IN_TIME"), 'YYYY-MM-DD') = T0."date"
...
LEFT JOIN (
  ...
  ON TO_CHAR(DATE_ADD(DATE_TRUNC('day', REQ."POINT_IN_TIME"), -86400, 'SECOND'), 'YYYY-MM-DD') = T1."date"
...
LEFT JOIN (
  ...
  ON TO_CHAR(DATE_ADD(DATE_TRUNC('day', REQ."POINT_IN_TIME"), 86400, 'SECOND'), 'YYYY-MM-DD') = T2."date"
