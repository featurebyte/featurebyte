WITH "REQUEST_TABLE_TIME_SERIES_W3_MONTH_0 0 * * *_Etc/UTC_CUSTOMER_ID_DISTINCT_BY_POINT_IN_TIME" AS (
  SELECT DISTINCT
    "POINT_IN_TIME",
    "CUSTOMER_ID",
    "__FB_CRON_JOB_SCHEDULE_DATETIME"
  FROM "REQUEST_TABLE_0 0 * * *_Etc/UTC"
), "REQUEST_TABLE_TIME_SERIES_W3_MONTH_0 0 * * *_Etc/UTC_CUSTOMER_ID_DISTINCT_BY_SCHEDULED_JOB_TIME" AS (
  SELECT
    "CUSTOMER_ID",
    "__FB_CRON_JOB_SCHEDULE_DATETIME",
    (
...
LEFT JOIN (
  ...
  FROM "REQUEST_TABLE_TIME_SERIES_W3_MONTH_0 0 * * *_Etc/UTC_CUSTOMER_ID_DISTINCT_BY_POINT_IN_TIME" AS DISTINCT_POINT_IN_TIME
  LEFT JOIN (
    SELECT
    ...
    FROM (
      SELECT
        ...
        VIEW."a"
      FROM "REQUEST_TABLE_TIME_SERIES_W3_MONTH_0 0 * * *_Etc/UTC_CUSTOMER_ID_DISTINCT_BY_SCHEDULED_JOB_TIME" AS REQ
      INNER JOIN "VIEW_7b71a24140f777c0" AS VIEW
