...
), "VIEW_37fb5d1ad04f52ed_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      FROM (
        ...
        INNER JOIN "VIEW_37fb5d1ad04f52ed_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
      ...
      INNER JOIN "VIEW_37fb5d1ad04f52ed" AS VIEW
