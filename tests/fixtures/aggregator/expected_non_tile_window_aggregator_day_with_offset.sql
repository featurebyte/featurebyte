WITH "REQUEST_TABLE_TIME_SERIES_W7_DAY_O3_DAY_0 0 * * *_Etc/UTC_CUSTOMER_ID" AS (
  SELECT
    "POINT_IN_TIME",
    "CUSTOMER_ID",
...
LEFT JOIN (
  ...
  FROM (
    SELECT
      ...
      REQ."CUSTOMER_ID",
      VIEW."a"
    FROM "REQUEST_TABLE_TIME_SERIES_W7_DAY_O3_DAY_0 0 * * *_Etc/UTC_CUSTOMER_ID" AS REQ
    INNER JOIN "VIEW_ea91ec70df690866" AS VIEW
