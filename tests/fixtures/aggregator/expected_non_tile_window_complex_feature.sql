WITH "REQUEST_TABLE_NO_TILE_W7200_F43200_BS900_M1800_CUSTOMER_ID_DISTINCT_BY_POINT_IN_TIME" AS (
  SELECT DISTINCT
    "POINT_IN_TIME",
    "CUSTOMER_ID",
...
), "REQUEST_TABLE_NO_TILE_W7200_F43200_BS900_M1800_CUSTOMER_ID_DISTINCT_BY_SCHEDULED_JOB_TIME" AS (
  SELECT
    "CUSTOMER_ID",
    "__FB_JOB_SCHEDULE_EPOCH",
    "__FB_JOB_SCHEDULE_EPOCH" - 900 - 7200 AS "__FB_WINDOW_START_EPOCH",
  ...
  LEFT JOIN (
    SELECT
      ...
      AGGREGATED."_fb_internal_CUSTOMER_ID_non_tile_window_sum_a_cust_id_None_W7200_43200_1800_900_0_input_1"
    FROM "REQUEST_TABLE_NO_TILE_W7200_F43200_BS900_M1800_CUSTOMER_ID_DISTINCT_BY_POINT_IN_TIME" AS DISTINCT_POINT_IN_TIME
    LEFT JOIN (
      SELECT
      ...
      FROM (
        SELECT
          ...
          REQ."CUSTOMER_ID",
          VIEW."a"
        FROM "REQUEST_TABLE_NO_TILE_W7200_F43200_BS900_M1800_CUSTOMER_ID_DISTINCT_BY_SCHEDULED_JOB_TIME" AS REQ
        INNER JOIN "VIEW_23253d663e8839ae" AS VIEW
