...
), "VIEW_e492f64273e37b0a_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      FROM (
        ...
        INNER JOIN "VIEW_e492f64273e37b0a_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
      ...
      INNER JOIN "VIEW_e492f64273e37b0a" AS VIEW
