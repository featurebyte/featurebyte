...
), "VIEW_5c8668792fb1eacf_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      FROM (
        ...
        INNER JOIN "VIEW_5c8668792fb1eacf_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
      ...
      INNER JOIN "VIEW_5c8668792fb1eacf" AS VIEW
