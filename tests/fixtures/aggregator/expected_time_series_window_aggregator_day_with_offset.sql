...
), "VIEW_24622223e3e688c1_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      FROM (
        ...
        INNER JOIN "VIEW_24622223e3e688c1_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
      ...
      INNER JOIN "VIEW_24622223e3e688c1" AS VIEW
