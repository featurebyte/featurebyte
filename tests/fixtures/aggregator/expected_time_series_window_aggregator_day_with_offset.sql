WITH "REQUEST_TABLE_TIME_SERIES_W7_DAY_O3_DAY_0 0 * * *_Etc/UTC_Asia/Singapore_CUSTOMER_ID_DISTINCT_BY_POINT_IN_TIME" AS (
  SELECT DISTINCT
    "POINT_IN_TIME" AS "POINT_IN_TIME",
    "CUSTOMER_ID" AS "CUSTOMER_ID",
    "__FB_CRON_JOB_SCHEDULE_DATETIME_0 0 * * *_Etc/UTC_Asia/Singapore" AS "__FB_CRON_JOB_SCHEDULE_DATETIME"
  FROM "REQUEST_TABLE"
), "REQUEST_TABLE_TIME_SERIES_W7_DAY_O3_DAY_0 0 * * *_Etc/UTC_Asia/Singapore_CUSTOMER_ID_DISTINCT_BY_SCHEDULED_JOB_TIME" AS (
  SELECT
    "CUSTOMER_ID",
    "__FB_CRON_JOB_SCHEDULE_DATETIME",
    DATE_PART(EPOCH_SECOND, DATE_TRUNC('day', "__FB_CRON_JOB_SCHEDULE_DATETIME")) - 259200 - 604800 AS "__FB_WINDOW_START_EPOCH",
    DATE_PART(EPOCH_SECOND, DATE_TRUNC('day', "__FB_CRON_JOB_SCHEDULE_DATETIME")) - 259200 AS "__FB_WINDOW_END_EPOCH"
  FROM (
    SELECT DISTINCT
      "CUSTOMER_ID" AS "CUSTOMER_ID",
      "__FB_CRON_JOB_SCHEDULE_DATETIME_0 0 * * *_Etc/UTC_Asia/Singapore" AS "__FB_CRON_JOB_SCHEDULE_DATETIME"
...
), "VIEW_81b788568f2a1795_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
...
LEFT JOIN (
  ...
  FROM "REQUEST_TABLE_TIME_SERIES_W7_DAY_O3_DAY_0 0 * * *_Etc/UTC_Asia/Singapore_CUSTOMER_ID_DISTINCT_BY_POINT_IN_TIME" AS DISTINCT_POINT_IN_TIME
  LEFT JOIN (
    SELECT
    ...
    FROM (
      ...
      FROM (
        ...
        FROM "REQUEST_TABLE_TIME_SERIES_W7_DAY_O3_DAY_0 0 * * *_Etc/UTC_Asia/Singapore_CUSTOMER_ID_DISTINCT_BY_SCHEDULED_JOB_TIME" AS REQ
        INNER JOIN "VIEW_81b788568f2a1795_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
      ...
      INNER JOIN "VIEW_81b788568f2a1795" AS VIEW
