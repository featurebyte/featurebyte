...
), "VIEW_de45badfa1fa8fb2_DISTINCT_REFERENCE_DATETIME" AS (
  SELECT
  ...
  LEFT JOIN (
    ...
    FROM (
      ...
      FROM (
        ...
        INNER JOIN "VIEW_de45badfa1fa8fb2_DISTINCT_REFERENCE_DATETIME" AS BUCKETED_REFERENCE_DATETIME
      ...
      INNER JOIN "VIEW_de45badfa1fa8fb2" AS VIEW
