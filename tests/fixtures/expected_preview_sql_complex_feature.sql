WITH TILE_F3600_M1800_B900_7BD30FF1B8E84ADD2B289714C473F1A21E9BC624 AS (
  SELECT
    sum_ef6e0961ae987b3faf4e63668d8997850e840d9a.INDEX,
    sum_ef6e0961ae987b3faf4e63668d8997850e840d9a."biz_id",
    value_sum_ef6e0961ae987b3faf4e63668d8997850e840d9a
  FROM (
    SELECT
      *,
  ...
  ) AS sum_ef6e0961ae987b3faf4e63668d8997850e840d9a
  ...
  SELECT
    ...
    "T2"."agg_w604800_sum_ef6e0961ae987b3faf4e63668d8997850e840d9a" AS "agg_w604800_sum_ef6e0961ae987b3faf4e63668d8997850e840d9a"
  ...
  LEFT JOIN (
    SELECT
      REQ."POINT_IN_TIME",
      REQ."BUSINESS_ID",
      SUM(value_sum_ef6e0961ae987b3faf4e63668d8997850e840d9a) AS "agg_w604800_sum_ef6e0961ae987b3faf4e63668d8997850e840d9a"
...
SELECT
  ...
  AGG."CUSTOMER_ID",
  (
    "agg_w7200_avg_33d7045ac1aea1e0a20f32ca16f997f220f5cbc8" / NULLIF("agg_w604800_sum_ef6e0961ae987b3faf4e63668d8997850e840d9a", 0)
  ) AS "Unnamed"
