...
"REQUEST_TABLE_W604800_F3600_BS900_M1800_BUSINESS_ID" AS (SELECT
  ...
  DATE_PART(epoch, POINT_IN_TIME) AS __FB_TS,
  FLOOR((__FB_TS - 1800) / 3600) AS __LAST_TILE_INDEX,
  __LAST_TILE_INDEX - 168 AS __FIRST_TILE_INDEX
FROM (
    SELECT DISTINCT
      POINT_IN_TIME,
      "BUSINESS_ID"
...
LEFT JOIN (
    ...
    INNER JOIN fake_transactions_table_f3600_m1800_b900_6df75fa33c5905ea927c25219b178c8848027e3c AS TILE
      ON (FLOOR(REQ.__LAST_TILE_INDEX / 168) = FLOOR(TILE.INDEX / 168) OR FLOOR(REQ.__LAST_TILE_INDEX / 168) - 1 = FLOOR(TILE.INDEX / 168))
