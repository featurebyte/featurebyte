...
from featurebyte import EventTable, FeatureJobSetting, ItemTable
...
joined_view = item_view.join_event_table_attributes(columns=["col_float"], event_suffix=None)
...
grouped = joined_view_1.groupby(by_keys=["cust_id"], category="col_int").aggregate_over(
    value_column=None,
    method="count",
    windows=["24h"],
...
grouped_1 = joined_view_1.groupby(by_keys=["cust_id"], category=None).aggregate_over(
