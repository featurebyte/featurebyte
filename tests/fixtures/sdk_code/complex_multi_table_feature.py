...
from featurebyte import ColumnCleaningOperation, EventTable, FeatureJobSetting, ItemTable, MissingValueImputation
...
joined_view_1 = event_view.add_feature(new_column_name="max_percent", feature=feat, entity_column="cust_id")
grouped = joined_view_1.groupby(by_keys=["cust_id"], category=None).aggregate_over(
