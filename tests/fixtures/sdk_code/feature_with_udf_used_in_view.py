...
from featurebyte import EventTable, FeatureJobSetting, UserDefinedFunction
...
udf_power_func = UserDefinedFunction.get_by_id(ObjectId("{power_function_id}"))
...
udf_cos_func = UserDefinedFunction.get_by_id(ObjectId("{cos_function_id}"))
