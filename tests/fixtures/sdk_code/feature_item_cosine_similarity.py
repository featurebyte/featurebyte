...
from featurebyte import FeatureJobSetting, ItemTable
...
grouped = item_view.groupby(by_keys=["cust_id_event_table"], category="item_id_col").aggregate_over(
    value_column="item_amount",
    method="sum",
    windows=["90d"],
    feature_names=["sum_item_amount_over_90d"],
    feature_job_setting=FeatureJobSetting(blind_spot="90s", period="360s", offset="180s"),
    skip_fill_na=True,
    offset=None,
)
feat = grouped["sum_item_amount_over_90d"]
grouped_1 = item_view.groupby(by_keys=["cust_id_event_table"], category="item_id_col").aggregate_over(
    value_column="item_amount",
    method="sum",
    windows=["30d"],
...
feat_2.name = "sum_item_amount_over_30d_cosine_similarity_sum_item_amount_over_90d"
output = feat_2
