...
from featurebyte import EventTable, FeatureJobSetting
...
grouped = event_view.as_features(column_names=["cust_id"], feature_names=["cust_id_feature"], offset=None)
...
grouped_1 = event_view.groupby(by_keys=["cust_id"], category="col_int").aggregate_over(
    ...
    feature_job_setting=FeatureJobSetting(blind_spot="3600s", period="3600s", offset="1800s"),
    skip_fill_na=True,
    offset=None,
)
