...
joined_view = event_view.add_feature(new_column_name="sum_item_amt", feature=feat_1, entity_column="cust_id")
...
grouped_1 = joined_view.groupby(by_keys=["cust_id"], category=None).aggregate_over(
