...
def test_point_in_time_minus_timestamp_feature(latest_event_timestamp_feature, update_fixtures):
    ...
    graph_node_type1 = output.graph.nodes_map["graph_1"].parameters.type
    graph_node_type2 = output.graph.nodes_map["graph_2"].parameters.type
    assert {graph_node_type1, graph_node_type2} == {
