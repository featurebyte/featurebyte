...
def test_join_parameters_columns__should_not_trigger_graph_inconsistency(
    ...
    # Need to ignore this warning because typeguard fails to recognize the column type
    filtered_joined_view = joined_view[joined_view["col_boolean_scd"] == True]  # noqa
