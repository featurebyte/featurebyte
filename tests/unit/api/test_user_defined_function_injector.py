...
def test_user_defined_function_injector_create_and_add_function(user_defined_function):
    ...
    # check docstring
    expected_doc = """
    This function uses the feature store SQL function `sql_function_name` to generate a new column
    ...
    Union[ViewColumn, Feature]
        A new column or new feature generated by the feature store function `sql_function_name`.
    """
