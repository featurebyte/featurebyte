...
def test_data_column_clone_with_replacement(source_col1):
    ...
    output = source_col1.clone_with_replacement(
        replace_node_name_map={"input_1": {"input_1", "project_1"}},
        node_name="graph_1",
    ...
    output = source_col1.clone_with_replacement(
        replace_node_name_map={"project_2": {"project_2"}},
        node_name="graph_1",
        node_transform="graph",
    )
    assert output == SourceDataColumn(
...
def test_derived_data_column_clone_with_replacement(derived_col1):
    ...
    output = derived_col1.clone_with_replacement(
        replace_node_name_map={"input_1": {"input_2"}, "add_1": {"add_2"}},
        node_name="graph_1",
        node_transform="graph",
    )
    assert output == {
    ...
    assert derived_col1.node_names == {"input_1", "add_1"}
    output = derived_col1.clone_with_replacement(
        replace_node_name_map={"input_1": {"input_2"}},
        node_name="graph_1",
        node_transform="graph",
    )
    assert output == {
