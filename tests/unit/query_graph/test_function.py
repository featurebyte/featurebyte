...
def test_generic_function__view_type(global_graph, input_node, database_details):
    ...
    state = SDKCodeExtractor(graph=global_graph).extract(node=gfunc, database_details=database_details)
...
def test_generic_function__feature_type(
    ...
    # check output operation structure
    op_struct = graph.extract_operation_structure(node=gfunc, keep_all_source_columns=keep_all_source_columns)
