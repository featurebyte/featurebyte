...
def test_graph_node_create__non_empty_input_nodes(input_node_params):
    ...
    pruned_graph, node_name_map = graph.prune(target_node=inserted_graph_node)  # noqa: F841
...
def test_graph_node__redundant_graph_node(input_node_params):
    ...
    def add_graph_node(query_graph, input_nodes):
        ...
        node_graph, proxy_inputs = GraphNode.create(  # noqa: F841
    ...
    pruned_graph, node_name_map = graph.prune(target_node=proj_node)  # noqa: F841
