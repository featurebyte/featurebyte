...
def test_get_feature_preview_sql(query_graph_with_groupby, helpers):
...
def test_get_feature_preview_sql__category_groupby(query_graph_with_category_groupby, helpers):
