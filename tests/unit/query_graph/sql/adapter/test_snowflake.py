            ...
            """
                ...
                FROM (
                  SELECT
                    ...
                    INITIAL_DATA.REQ."serving_name_2" AS "serving_name_2",
                  ...
                  FROM (
                    ...
                    VECTOR_AGGREGATE_SUM(parent) OVER (PARTITION BY INITIAL_DATA.REQ."serving_name", INITIAL_DATA.REQ."serving_name_2")
                  ) AS "AGG_0"
                ) AS VECTOR_T0
                INNER JOIN (
                  SELECT
                  ...
                  FROM (
                    ...
                    VECTOR_AGGREGATE_SUM(parent2) OVER (PARTITION BY INITIAL_DATA.REQ."serving_name", INITIAL_DATA.REQ."serving_name_2")
                  ) AS "AGG_1"
                ) AS VECTOR_T1
                ...
                INNER JOIN (
                  ...
                  FROM (
                    ...
                    VECTOR_AGGREGATE_SUM(parent3) OVER (PARTITION BY INITIAL_DATA.REQ."serving_name", INITIAL_DATA.REQ."serving_name_2")
                  ) AS "AGG_2"
                ) AS VECTOR_T2
