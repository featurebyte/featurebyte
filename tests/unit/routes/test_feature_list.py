...
class TestFeatureListApi(BaseApiTestSuite):
    ...
    create_conflict_payload_expected_detail_pairs = [
        ...
        (
            ...
            "FeatureList (feature_ids: \"[ObjectId('6332dfc6d9532cdb02748f89')]\") already exists. "
            'Get the existing object by `FeatureList.get(name="sf_feature_list")`.',
        ),
    ]
    create_unprocessable_payload_expected_detail_pairs = [
        ...
        (
            payload_multi,
            'Feature (id: "6332dfc6d9532cdb02748f8b") not found. Please save the Feature object first.',
        ),
        (
            {**payload, "feature_ids": []},
            [
