...
@pytest.mark.parametrize(
    "target_spec,expected_import,expected_field",
    [
        (None, "DoubleType, LongType, StructField, StructType", "DoubleType"),
        (
            ColumnSpec(name="target_column", dtype="FLOAT"),
            "DoubleType, LongType, StructField, StructType",
            "DoubleType",
        ),
        (
            ColumnSpec(name="another_target", dtype="VARCHAR"),
...
def test_databricks_feature_specs_definition(
    ...
    schema = StructType(
        [
            StructField(target_column, [TARGET_FIELD]()),
