...
def test_insert_feature_registry(
    ...
    feature_list_manager.insert_feature_list_registry(mock_snowflake_feature_list_model)
    assert mock_execute_query.call_count == 2

    feature_lst = [
        {"feature": f[0], "version": f[1]} for f in mock_snowflake_feature_list_model.features
    ]
...
def test_update_feature_list(
    ...
    feature_list_manager.update_feature_list_registry(mock_snowflake_feature_list_model)
    assert mock_execute_query.call_count == 2
