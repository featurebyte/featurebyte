...
def test_format_mongo_uri():
    ...
    """
    assert format_mongo_uri_for_scheduler("mongodb://localhost:27017/") == "mongodb://localhost:27017/"
    assert (
    ...
    assert (
        format_mongo_uri_for_scheduler("mongodb://localhost:27017,localhost:27018/admin?replicaSet=rs&ssl=false")
